...
const COMPLETED_DETAILS = {
  data: {
    ...
    tasks: [
      {
        id: "t1", projectRunId: "pr_done", title: "Backend", description: "x",
        role: "backend", status: "completed", priority: 1, dependsOn: [],
        allowedFiles: [], acceptanceCriteria: [], assignedModelId: null,
        assignedProviderId: null, metadata: null,
      },
      {
        id: "t2", projectRunId: "pr_done", title: "Frontend", description: "x",
        role: "frontend", status: "completed", priority: 1, dependsOn: [],
        allowedFiles: [], acceptanceCriteria: [], assignedModelId: null,
        assignedProviderId: null, metadata: null,
      },
    ],
    agentRuns: [
      { id: "ag_i", projectRunId: "pr_done", taskId: null, runId: null, role: "intake", status: "completed", modelId: "gpt-4o", providerId: null, output: null, inputTokens: 10, outputTokens: 20, totalTokens: 30, latencyMs: 100, errorType: null, errorMessage: null, startedAt: "2026-06-08T10:00:00Z", completedAt: "2026-06-08T10:00:01Z" },
      { id: "ag_p", projectRunId: "pr_done", taskId: null, runId: null, role: "planner", status: "completed", modelId: "gpt-4o", providerId: null, output: null, inputTokens: 10, outputTokens: 20, totalTokens: 30, latencyMs: 200, errorType: null, errorMessage: null, startedAt: "2026-06-08T10:00:02Z", completedAt: "2026-06-08T10:00:03Z" },
      { id: "ag_w1", projectRunId: "pr_done", taskId: "t1", runId: null, role: "backend", status: "completed", modelId: "gpt-4o", providerId: null, output: null, inputTokens: 10, outputTokens: 20, totalTokens: 30, latencyMs: 300, errorType: null, errorMessage: null, startedAt: "2026-06-08T10:00:04Z", completedAt: "2026-06-08T10:00:07Z" },
      { id: "ag_w2", projectRunId: "pr_done", taskId: "t2", runId: null, role: "frontend", status: "completed", modelId: "gpt-4o", providerId: null, output: null, inputTokens: 10, outputTokens: 20, totalTokens: 30, latencyMs: 300, errorType: null, errorMessage: null, startedAt: "2026-06-08T10:00:04Z", completedAt: "2026-06-08T10:00:07Z" },
      { id: "ag_s", projectRunId: "pr_done", taskId: null, runId: null, role: "supervisor", status: "completed", modelId: "gpt-4o", providerId: null, output: null, inputTokens: 10, outputTokens: 20, totalTokens: 30, latencyMs: 300, errorType: null, errorMessage: null, startedAt: "2026-06-08T10:00:08Z", completedAt: "2026-06-08T10:00:09Z" },
      { id: "ag_in", projectRunId: "pr_done", taskId: null, runId: null, role: "integrator", status: "completed", modelId: "gpt-4o", providerId: null, output: null, inputTokens: 10, outputTokens: 20, totalTokens: 30, latencyMs: 300, errorType: null, errorMessage: null, startedAt: "2026-06-08T10:00:10Z", completedAt: "2026-06-08T10:00:11Z" },
    ],
    artifacts: [
      { id: "art_plan", projectRunId: "pr_done", taskId: null, agentRunId: "ag_p", type: "plan", name: "plan.json", content: { tasks: [] }, contentKind: "json", sizeBytes: 1024, truncated: false, metadata: null, createdAt: "2026-06-08T10:00:03Z" },
      { id: "art_w1", projectRunId: "pr_done", taskId: "t1", agentRunId: "ag_w1", type: "worker", name: "worker-backend-t1.json", content: { ok: true }, contentKind: "json", sizeBytes: 2048, truncated: false, metadata: null, createdAt: "2026-06-08T10:00:07Z" },
      { id: "art_rev", projectRunId: "pr_done", taskId: null, agentRunId: "ag_s", type: "review", name: "review.md", content: "{\"pass\": true}", contentKind: "json", sizeBytes: 256, truncated: false, metadata: null, createdAt: "2026-06-08T10:00:09Z" },
      { id: "art_final", projectRunId: "pr_done", taskId: null, agentRunId: "ag_in", type: "final_plan", name: "final-plan.md", content: "# Plan", contentKind: "text", sizeBytes: 512, truncated: false, metadata: null, createdAt: "2026-06-08T10:00:11Z" },
    ],
  },
};
